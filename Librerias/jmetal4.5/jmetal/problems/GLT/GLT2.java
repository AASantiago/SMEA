 ...
 */
public class GLT2 extends Problem {   
 /** 
  * Creates a default DTLZ1 problem (7 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public GLT2(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public GLT2(String solutionType, 
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
    ...
    for(int i=1;i<numberOfVariables_;i++)
    {
      ...
      solution.setObjective(0,(1.0+g)*(1.0-Math.cos(((x[0]*Math.PI)/2.0))));
      solution.setObjective(1,(1.0+g)*(10.0-10.0*Math.sin((x[0]*Math.PI)/2.0)));
  } // evaluate   
