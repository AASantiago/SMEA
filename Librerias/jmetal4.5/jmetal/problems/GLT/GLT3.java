...
public class GLT3 extends Problem {   
  ...
  */
  public GLT3(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public GLT3(String solutionType, 
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
    ...
    for(int i=1;i<numberOfVariables_;i++)
    {
      ...
      if(y<=0.05)
      {
          solution.setObjective(1,(1.0+g)*(1.0-19.0*x[0]));
      }
      else
      {
          solution.setObjective(1,(1.0+g)*(1.0/19.0-x[0]/19.0));
      }    
  } // evaluate   
