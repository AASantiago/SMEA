 ...
 */
public class GLT4 extends Problem {   
 /** 
  * Creates a default DTLZ1 problem (7 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public GLT4(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public GLT4(String solutionType, 
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
    ...
    double val=2.0-2.0*Math.pow(x[0],0.5)*Math.pow(Math.cos(2.0*Math.pow(x[0],0.5)*Math.PI),2.0);
    solution.setObjective(1,(1.0+g)*val);
  } // evaluate   
